...
def run_optimization(gui_app, n_trials, param_ranges):
    def objective(trial):
        # Mapping des paramètres dynamiques
        params = {
        ...
        scores = []
        fichiers = glob(os.path.join(INPUT_FOLDER, '*.*'))[:10]  # Toujours limiter aux 10 premiers pour la vitesse
        ...
        # Callback vers la GUI pour mise à jour
